...
{
    public class LevelOneTemp
    {
        private static LevelOneTemp instance;
        ...
        public static LevelOneTemp GetInstance()
        {
            if (instance == null)
            {
                instance = new LevelOneTemp();
            }
        ...
        private int[,] ReadCsv()
        {
            string[] lines = File.ReadAllLines("C:\\Users\\Tim\\source\\repos\\game-darksouls\\game-darksouls\\Levels\\csv levels\\map.csv");
